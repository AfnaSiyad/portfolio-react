          ...
          <div className="counter-wraper">
            <div className="col-md-3">
              <div className="counter-icon">
                <span className="counter-icon-circle">
            ...
            <div className="col-md-3">
              <div className="counter-icon">
                <span className="counter-icon-circle">
                  <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-journal-richtext" viewBox="0 0 16 16">
